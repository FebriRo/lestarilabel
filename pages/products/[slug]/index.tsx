    ...
    return (
      ...
      <section className="max-w-6xl mx-auto px-8 py-12 grid md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div
            ref={sliderRef}
            className="flex gap-3 mt-4 overflow-x-auto cursor-grab active:cursor-grabbing scrollbar-hide"
          ...
          >
            ...
            {product.images.map((img, index) => (
              ...
              <button
                ...
                className={`min-w-[80px] aspect-square rounded-lg overflow-hidden border-2 transition
                  ${selectedImage === img
                    ? "border-red-600"
